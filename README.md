# E-VRPTW Solution Verifier (Python)
...
Requires Python installed (tested with Python 3.13). See https://www.python.org/downloads/ for instructions to set up Python.

Requires `click` package for cli parsing. Install dependencies running `python -m pip install -r requirements.txt` in the root folder.

## Usage

Run `python src/main.py --instance ./resources/test-instances/c101C10.txt --solution ./resources/test-solutions/c101C10_2.sol`
* `instance` : path to the instance file
* `solution` : path to the solution files to be verified
